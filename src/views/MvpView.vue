        ...
        stepsDev: [
          {
            ...
            description:
              "Сбор и анализ данных, определение ключевых метрик, идентификацию потребностей пользователей для создания продукта",
          },
          {
            id: 2,
            number: "Шаг 2",
            ...
            description:
              "Исследование рынка, создание уникального предложения, разработка стратегии и прототипов, тестирование, запуск, сбор данных для адаптации",
          },
          {
            id: 3,
            number: "Шаг 3",
            ...
            description:
              "Cоздание интуитивного интерфейса и уникального пользовательского опыта для максимальной удовлетворенности и привлекательности пользователей",
          },
          {
            id: 4,
            number: "Шаг 4",
            ...
            description:
              "Создание базового функционала, обеспечивающего его быстрый запуск и тестирование на первых пользователях",
          },
        ],
        arcFooters: [
          {
            ...
            arcclass: "arc_3",
            iconarc:
              '<svg xmlns="http://www.w3.org/2000/svg" width="636" height="304" viewBox="0 0 636 304" fill="none"><path d="M12 36.8592C37.7503 68.1627 66.3379 97.4602 95.9564 125.247C133.976 160.916 174.264 189.119 220.012 214.556C287.118 251.869 356.354 286.614 434.758 291.282C477.815 293.845 532.133 290.742 566.802 261.973C591.229 241.702 611.99 207.32 617.865 176.347C627.948 123.193 622.564 66.0343 622.564 12.0001" stroke="url(#paint0_linear_2253_14484)" stroke-width="24" stroke-linecap="round"/><defs><linearGradient id="paint0_linear_2253_14484" x1="306" y1="262.5" x2="632.46" y2="89.9242" gradientUnits="userSpaceOnUse"><stop stop-color="#D3E1FC"/><stop offset="1" stop-color="#FF404E" stop-opacity="0"/></linearGradient></defs></svg>',
          },
        ],
      },
    };
